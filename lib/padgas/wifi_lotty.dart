...
class wifipadges extends StatefulWidget {
  @override
  wifipadgesState createState() => wifipadgesState();
}

class wifipadgesState extends State<wifipadges> with TickerProviderStateMixin {
...
class DrawPath extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    Color designColor = const Color(0xFF6101EB);
